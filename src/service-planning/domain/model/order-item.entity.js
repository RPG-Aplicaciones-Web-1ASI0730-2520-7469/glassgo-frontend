/**
 * OrderItem Entity
 * Represents an item within an order, part of the Order aggregate in Domain-Driven Design.
 * Encapsulates product reference, quantity, and pricing logic for individual order lines.
 */
