...
<script setup>
/**
 * Crear Pedido View - Presentation Layer
 * Vue component for creating new orders in the service planning bounded context.
 * Provides UI for product search, order item management, delivery information, and order submission.
 * Integrates with OrdersStore for business logic and state management.
 */

import { ref, computed, onMounted, watch } from 'vue';
import { useRouter } from 'vue-router';
import { useOrdersStore } from '../../application/order-stores.js';
 ...
 * Filters available products based on search query and updates search results.
 */
...
/**
 * Show all available products in search results
 */
 ...
 * Shows search results if query is valid
 */
...
/**
 * Toggle expanded state of order item details
...
/**
 * Reset current order and delivery info
 */
const resetOrder = () => {
...
/**
 * Close success modal after order submission
 */
